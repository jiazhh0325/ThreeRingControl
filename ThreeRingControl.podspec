...
Pod::Spec.new do |s|
  ...
  s.description  = "hello, this is a framework test!"

  s.homepage     = "https://github.com/jiazhh0325/ThreeRingControl"
  ...
  s.source        = { :git => "https://github.com/jiazhh0325/ThreeRingControl", :tag => "1.0.0" }
